        ...
        case  CMBS_LA_LIST_MISSED_CALLS:
            switch (u32_FieldId)
            {
                ...
                case CMBS_MCL_FLD_NAME:
                    return FIELD_ID_LAST_NAME;
                case CMBS_MCL_FLD_DATETIME:
                    return FIELD_ID_DATE_AND_TIME;
                case CMBS_MCL_FLD_NEW:
                    return FIELD_ID_READ_STATUS;
                case CMBS_MCL_FLD_LINE_NAME:
                    return FIELD_ID_LINE_NAME;
                case CMBS_MCL_FLD_LINE_ID:
                    return FIELD_ID_LINE_ID;
                case CMBS_MCL_FLD_NR_OF_CALLS:
                    return FIELD_ID_NUM_OF_CALLS;
                default:
        ...
        case  CMBS_LA_LIST_CONTACT:
            switch (u32_FieldId)
            {
                ...
                case CMBS_CL_FLD_FIRST_NAME:
                    return FIELD_ID_FIRST_NAME;
                case CMBS_CL_FLD_CONTACT_NR:
                    return FIELD_ID_CONTACT_NUM_1;
                case CMBS_CL_FLD_ASSOC_MDY:
                    return FIELD_ID_ASSOCIATED_MELODY;
        ...
        case  CMBS_LA_LIST_LINE_SETTINGS:
            switch (u32_FieldId)
            {
                ...
                case CMBS_LSL_FLD_ATTACHED_HANDSETS:
                    return FIELD_ID_ATTACHED_HANDSETS;
                case CMBS_LSL_FLD_DIALING_PREFIX:
                    return FIELD_ID_DIALING_PREFIX;
                case CMBS_LSL_FLD_FP_MELODY:
                    return FIELD_ID_FP_MELODY;
                case CMBS_LSL_FLD_FP_VOLUME:
                    return FIELD_ID_FP_VOLUME;
                case CMBS_LSL_FLD_BLOCKED_NUMBER:
                    return FIELD_ID_BLOCKED_NUMBER;
                case CMBS_LSL_FLD_MULTI_CALL_MODE:
                    return FIELD_ID_MULTIPLE_CALLS_MODE;
                case CMBS_LSL_FLD_INTRUSION_CALL:
                    return FIELD_ID_INTRUSION_CALL;
                case CMBS_LSL_FLD_PERMANENT_CLIR:
                    return FIELD_ID_PERMANENT_CLIR;
                case CMBS_LSL_FLD_CALL_FORWARDING:
                    return FIELD_ID_CALL_FWD_UNCOND;
                case CMBS_LSL_FLD_CFNA:
                    return FIELD_ID_CALL_FWD_NO_ANSWER;
                case CMBS_LSL_FLD_CFB:
                    return FIELD_ID_CALL_FWD_BUSY;
                default:
                    return FIELD_ID_INVALID;
            }
            break;
...
static s32 AppFieldId_2_CATiqFieldId(IN u32 u32_ListId, IN u32 u32_FieldId)
{
    ...
    switch (u32_ListId)
    {
        case  CMBS_LA_LIST_MISSED_CALLS:
            switch (u32_FieldId)
            {
                case FIELD_ID_NUMBER:
                    return  CMBS_MCL_FLD_NUMBER;
                case FIELD_ID_LAST_NAME:
                    return  CMBS_MCL_FLD_NAME;
                case FIELD_ID_DATE_AND_TIME:
                    return  CMBS_MCL_FLD_DATETIME;
                case FIELD_ID_READ_STATUS:
                    return  CMBS_MCL_FLD_NEW;
                case FIELD_ID_LINE_NAME:
                    return  CMBS_MCL_FLD_LINE_NAME;
                case FIELD_ID_LINE_ID:
                    return  CMBS_MCL_FLD_LINE_ID;
                case FIELD_ID_NUM_OF_CALLS:
                    return  CMBS_MCL_FLD_NR_OF_CALLS;
                default:
        ...
        case  CMBS_LA_LIST_OUTGOING_CALLS:
            ...
            {
                case FIELD_ID_NUMBER:
                    return CMBS_OCL_FLD_NUMBER;
                case FIELD_ID_LAST_NAME:
                    return CMBS_OCL_FLD_NAME;
                case FIELD_ID_DATE_AND_TIME:
                    return CMBS_OCL_FLD_DATETIME;
                case FIELD_ID_LINE_NAME:
                    return CMBS_OCL_FLD_LINE_NAME;
                case FIELD_ID_LINE_ID:
                    return CMBS_OCL_FLD_LINE_ID;
                default:
                    return CMBS_FLD_UNDEFINED;
            }
            break;
        ...
        case  CMBS_LA_LIST_INCOMING_ACC:
            ...
            {
                case FIELD_ID_NUMBER:
                    return CMBS_IACL_FLD_NUMBER;
                case FIELD_ID_LAST_NAME:
                    return CMBS_IACL_FLD_NAME;
                case FIELD_ID_DATE_AND_TIME:
                    return CMBS_IACL_FLD_DATETIME;
                case FIELD_ID_LINE_NAME:
                    return CMBS_IACL_FLD_LINE_NAME;
                case FIELD_ID_LINE_ID:
                    return CMBS_IACL_FLD_LINE_ID;
                default:
                    return CMBS_FLD_UNDEFINED;
            }
            break;
        ...
        case  CMBS_LA_LIST_ALL_CALLS:
            switch (u32_FieldId)
            {
                case FIELD_ID_CALL_TYPE:
                    return CMBS_ACL_FLD_CALL_TYPE;
                case FIELD_ID_NUMBER:
                    return CMBS_ACL_FLD_NUMBER;
                case FIELD_ID_LAST_NAME:
                    return CMBS_ACL_FLD_NAME;
                case FIELD_ID_DATE_AND_TIME:
                    return CMBS_ACL_FLD_DATETIME;
                case FIELD_ID_LINE_NAME:
                    return CMBS_ACL_FLD_LINE_NAME;
                case FIELD_ID_LINE_ID:
                    return CMBS_ACL_FLD_LINE_ID;
                default:
                    return CMBS_FLD_UNDEFINED;
            }
            break;
        ...
        case  CMBS_LA_LIST_CONTACT:
            ...
            {
                case FIELD_ID_LAST_NAME:
                    return CMBS_CL_FLD_NAME;
                case FIELD_ID_FIRST_NAME:
                    return CMBS_CL_FLD_FIRST_NAME;
                case FIELD_ID_CONTACT_NUM_1:
                    return CMBS_CL_FLD_CONTACT_NR;
                case FIELD_ID_CONTACT_NUM_2:
                    return CMBS_CL_FLD_CONTACT_NR;
                case FIELD_ID_ASSOCIATED_MELODY:
                    return CMBS_CL_FLD_ASSOC_MDY;
                case FIELD_ID_LINE_ID:
                    return CMBS_CL_FLD_LINE_ID;
                default:
                    return CMBS_FLD_UNDEFINED;
            }
            break;
        ...
        case  CMBS_LA_LIST_LINE_SETTINGS:
            ...
            {
                case FIELD_ID_LINE_NAME:
                    return CMBS_LSL_FLD_LINE_NAME;
                case FIELD_ID_LINE_ID:
                    return CMBS_LSL_FLD_LINE_ID;
                case FIELD_ID_ATTACHED_HANDSETS:
                    return CMBS_LSL_FLD_ATTACHED_HANDSETS;
                case FIELD_ID_DIALING_PREFIX:
                    return CMBS_LSL_FLD_DIALING_PREFIX;
                case FIELD_ID_FP_MELODY:
                    return CMBS_LSL_FLD_FP_MELODY;
                case FIELD_ID_FP_VOLUME:
                    return CMBS_LSL_FLD_FP_VOLUME;
                case FIELD_ID_BLOCKED_NUMBER:
                    return CMBS_LSL_FLD_BLOCKED_NUMBER;
                case FIELD_ID_MULTIPLE_CALLS_MODE:
                    return CMBS_LSL_FLD_MULTI_CALL_MODE;
                case FIELD_ID_INTRUSION_CALL:
                    return CMBS_LSL_FLD_INTRUSION_CALL;
                case FIELD_ID_PERMANENT_CLIR:
                    return CMBS_LSL_FLD_PERMANENT_CLIR;
                case FIELD_ID_CALL_FWD_UNCOND:
                    return CMBS_LSL_FLD_CALL_FORWARDING;
                case FIELD_ID_CALL_FWD_NO_ANSWER:
                    return CMBS_LSL_FLD_CFNA;
                case FIELD_ID_CALL_FWD_BUSY:
                    return CMBS_LSL_FLD_CFB;
                default:
                    return CMBS_FLD_UNDEFINED;
            }
            break;
        ...
        case  CMBS_LA_LIST_ALL_INCOMING_CALLS:
            ...
            {
                case FIELD_ID_NUMBER:
                    return CMBS_AICL_FLD_NUMBER;
                case FIELD_ID_LAST_NAME:
                    return CMBS_AICL_FLD_NAME;
                case FIELD_ID_DATE_AND_TIME:
                    return CMBS_AICL_FLD_DATETIME;
                case FIELD_ID_READ_STATUS:
                    return CMBS_AICL_FLD_NEW;
                case FIELD_ID_LINE_NAME:
                    return CMBS_AICL_FLD_LINE_NAME;
                case FIELD_ID_LINE_ID:
                    return CMBS_AICL_FLD_LINE_ID;
                case FIELD_ID_NUM_OF_CALLS:
                    return CMBS_AICL_FLD_NR_OF_CALLS;
                default:
                    return CMBS_FLD_UNDEFINED;
            }
            break;
            ...
            case CMBS_ACL_FLD_CALL_TYPE:
            {
                ...
                switch (pst_AppEntry->cCallType)
                {
                    case CALL_TYPE_MISSED:
                        st_LA_Fld_CallType.u8_Attribute = 0x20;
                        break;
                    case CALL_TYPE_OUTGOING:
                        st_LA_Fld_CallType.u8_Attribute = 0x08;
                        break;
                    case CALL_TYPE_INCOMING:
                        st_LA_Fld_CallType.u8_Attribute = 0x10;
                        break;
                    default:
                        break;
                }
        ...
        switch (pst_Fields->pu16_FieldId[u16_FieldIdx])
        {
            ...
            case CMBS_CL_FLD_CONTACT_NR:
            {
                ...
                if (bContactNumber == FALSE)
                {
                    ...
                    {
                        case NUM_TYPE_FIXED:
                            st_LA_Fld_ContactNumber.u8_Attribute |= 0x08;
                            break;
                        case NUM_TYPE_MOBILE:
                            st_LA_Fld_ContactNumber.u8_Attribute |= 0x04;
                            break;
                        case NUM_TYPE_WORK:
                            st_LA_Fld_ContactNumber.u8_Attribute |= 0x02;
                            break;
                        default:
                            break;
                    }
        ...
        OUT u16* pu16_CurrNumOfEntries)
{
    ...
    {
        printf("LASessionMgr_StartSession: Invalid List ID!\n");
        return LA_SESSION_MGR_RC_UNSUPPORTED_LIST;
    }
        ...
        OUT u8 pu8_Data[], INOUT u16* pu16_DataLen)
{
    ...
    switch (eMark)
    {
        case CMBS_MARK_REQUEST_SET_READ_STATUS:
            eReadMark = MARK_SET;
            break;
        case CMBS_MARK_REQUEST_RESET_READ_STATUS:
            eReadMark = MARK_CLEAR;
            break;
        default:
            eReadMark = MARK_LEAVE_UNCHANGED;
            break;
    }
        ...
        OUT u8 pu8_Data[], INOUT u16* pu16_DataLen, OUT u32* pu32_StartIdx)
{
    ...
    switch (eMatch)
    {
        case CMBS_LA_SEARCH_MATCHING_EXACT_NEXT:
            eSearchMatch = MATCH_RETURN_NEXT_ON_FAIL;
            break;
        case CMBS_LA_SEARCH_MATCHING_EXACT_PREV:
            eSearchMatch = MATCH_RETURN_PREV_ON_FAIL;
            break;
        default:
            eSearchMatch = MATCH_EXACT;
            break;
    }
...
LA_SESSION_MGR_RC LASessionMgr_SaveEntry(IN u16 u16_SessionId, OUT u32* pu32_EntryId, OUT u32* pu32_PositionIdx, OUT u32* pu32_TotalNumEntries)
{
    ...
    u32 u32_listId, pu32_Fields[LA_SESSION_MGR_MAX_FIELDS], u32_FieldsNum = 0, u32_index;
    LIST_RC list_rc;
    ...
    *pu32_EntryId = g_pst_LASessions[s32_Index].u32_SaveEntryId;
    ...
    if (u32_listId == LIST_TYPE_LINE_SETTINGS_LIST)
    {
        ...
        stLineSettings.u8_Multiple_Calls    = st_Entry.bMultiCalls ? 4 : 0;
